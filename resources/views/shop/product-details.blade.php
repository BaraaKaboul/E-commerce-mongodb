                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/'.$product->image)}}" width="674"
                                             height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/'.$product->image)}}" data-bs-toggle="tooltip"
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/Gallery/'.$imgs)}}" width="674"
                                             height="674" alt="" />
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                                                                              src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/'.$product->image)}}" width="104" height="104" alt="" /></div>
                                    @foreach($product->images as $imgs)
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                                                                              src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/Gallery/'.$imgs)}}" width="104" height="104" alt="" /></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
              ...
              "992": {
                ...
                "spaceBetween": 30
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @foreach($rproduct as $rdata)
                        <div class="swiper-slide product-card">
                            <div class="pc__img-wrapper">
                                <a href="{{route('shop.product_details',$rdata->slug)}}">
                                    <img loading="lazy" src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/'.$product->image)}}" width="330" height="400"
                                         alt="{{$rdata->name}}" class="pc__img">
                                    @foreach($product->images as $imgs)
                                    <img loading="lazy" src="{{asset('Attachments/'.$product->brand->name.'/'.$product->name.'/Gallery/'.$imgs)}}" width="330" height="400"
                                         alt="{{$rdata->name}}" class="pc__img pc__img-second">
                                    @endforeach
                                </a>
                                <button
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">{{$rdata->category->name}}</p>
                                <h6 class="pc__title"><a href="{{route('shop.product_details',$rdata->slug)}}">{{$rdata->name}}</a></h6>
