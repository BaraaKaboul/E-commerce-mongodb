                    ...
                    <div class="product-card-wrapper">
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="{{route('shop.product_details',$data->slug)}}"><img loading="lazy" src="{{asset('Attachments/'.$data->brand->name.'/'.$data->name.'/'.$data->image)}}" width="330"
                                                                        height="400" alt="{{$data->name}}" class="pc__img"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            @foreach($data->images as $imgs)
                                            <a href="{{route('shop.product_details',$data->slug)}}"><img loading="lazy" src="{{'Attachments/' . $imgs}}"
                      ...
                      <use href="#icon_next_sm" />
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">{{$data->category->name}}</p>
                                <h6 class="pc__title"><a href="{{route('shop.product_details',$data->slug)}}">{{$data->name}}</a></h6>
                                <div class="product-card__price d-flex">
                                    <span class="money price">
                                        @if($data->sale_proice)
                                            <s>${{$data->regular_price}}</s> ${{$data->sale_price}}
                                        @else
                                            ${{$data->regular_price}}
                                        @endif
                                    </span>
